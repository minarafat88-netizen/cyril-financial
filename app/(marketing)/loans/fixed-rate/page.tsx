...
import { ShieldCheck, ArrowRight, CheckCircle2, Send, FileSpreadsheet, ShieldAlert } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="bg-navy text-white p-10 lg:p-14 rounded-3xl shadow-glass space-y-6">
            ...
            <p className="text-gray-300 text-lg leading-relaxed max-w-2xl">
              Traditional stability with consistent monthly principal and interest payments for the entire life of your loan.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
              ...
              <div className="space-y-4 pt-4 border-t border-gray-100">
                ...
                <div className="grid grid-cols-1 gap-3">
                  {[
                    ...
                    "Competitive, locked-in interest rates"
                  ].map((benefit, idx) => (
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              {/* Refactored Fixed-Rate Calculator Card */}
              <div className="bg-transparent rounded-3xl space-y-5">
                <MortgageCalculator defaultHomePrice={400000} />
              </div>
