...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="space-y-8 p-8 bg-gray-50 min-h-screen font-sans text-navy">
      <div>
      ...
      <div className="bg-white rounded-3xl shadow-luxury border border-gray-100 p-8 max-w-3xl space-y-6">
        <div className="flex items-center gap-4 border-b border-gray-100 pb-6">
          <div className="w-12 h-12 bg-navy text-white rounded-2xl flex items-center justify-center shadow-sm border border-gray-200">
        ...
        <form onSubmit={handleSave} className="space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input defaultValue="Cyril Financial Group" className="bg-gray-50 border-gray-200 rounded-xl" />
            </div>
            <div>
              <label className="block text-xs font-bold text-navy uppercase tracking-wider mb-1.5">Corporate Domain</label>
              <Input defaultValue="https://cyrilfinancial.com" className="bg-gray-50 border-gray-200 rounded-xl" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input defaultValue="02198421" className="bg-gray-50 border-gray-200 rounded-xl" />
            </div>
            <div>
              <label className="block text-xs font-bold text-navy uppercase tracking-wider mb-1.5">NMLS Unique Identifier</label>
              <Input defaultValue="2481023" className="bg-gray-50 border-gray-200 rounded-xl" />
            </div>
          </div>

          <div>
            <label className="block text-xs font-bold text-navy uppercase tracking-wider mb-1.5">Primary Support Email</label>
            <Input defaultValue="advisory@cyrilfinancial.com" type="email" className="bg-gray-50 border-gray-200 rounded-xl" />
          </div>
          ...
          <button type="submit" className="w-full md:w-auto bg-navy hover:bg-navy-dark text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition-all flex items-center justify-center gap-2 text-sm cursor-pointer">
