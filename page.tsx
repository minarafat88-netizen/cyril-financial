...
export default function LoginPage() {
  ...
  const onGoogleSignIn = () => {
    // Redirect to the NextAuth.js Google sign-in page
    router.push('/api/auth/signin/google');
  };

  const onAppleSignIn = () => {
    // Apple Sign-In is not yet implemented with the new auth system
  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-screen bg-cover bg-center" style={{ backgroundImage: "url('/images/login-background.jpg')" }}>
      ...
      <div className="relative p-8 bg-white rounded-xl shadow-lg w-full max-w-md">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors"
          >
            <GoogleIcon />
            Sign in with Google
          </button>
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-900 bg-gray-900 text-white rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors"
          >
            <AppleIcon />
            Sign in with Apple
          </button>
